...
**[Addtag](#adding-tags--addtag)** | Add tag(s) to the tag list      | `addtag t/[TAG]`<br> e.g., `add_tags n/Math`
**[Deletetag](#deleting-tags--deletetag)** | Delete tag(s) from the tag list | `deletetag t/[TAG]`<br> e.g., `delete_tags t/Math`
